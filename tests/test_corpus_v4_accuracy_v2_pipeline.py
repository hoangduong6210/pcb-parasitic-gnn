...
import plan_corpus_v4_accuracy_v2 as planner  # noqa: E402
import plan_corpus_v4_accuracy_resume_v2 as resume  # noqa: E402
import run_corpus_v4_accuracy_task_v2 as runner  # noqa: E402
...
def test_crossed_interval_is_deterministic_and_labeled_descriptive() -> None:
    protocol = json.loads((ROOT / "protocols/corpus_v4_accuracy_v2.json").read_text())
...
def _protocol() -> dict[str, Any]:
    return json.loads((ROOT / "protocols/corpus_v4_accuracy_v2.json").read_text())
    ...
    curve = [
        {
            "epoch": epoch,
            "learning_rate": 1e-3,
            "schema": "pcb-gnn.corpus-v4-accuracy-learning-curve.v2",
...
def _accepted_set_fixture(
    ...
    candidate = {
        ...
        "schema": "pcb-gnn.corpus-v4-accuracy-candidate-index.v2",
    }
...
def test_batch_resources_and_no_login_training_contract() -> None:
    training = (ROOT / "code/jobs/submit_corpus_v4_accuracy_v2.sh").read_text()
    final = (ROOT / "code/jobs/submit_finalize_corpus_v4_accuracy_v2.sh").read_text()
