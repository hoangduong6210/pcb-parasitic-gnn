...
import verify_corpus_v4_accuracy_archive as archive  # noqa: E402
...
def _archive_replay_fixture(
    ...
    documents = {
        ...
        "checkpoint_index.json": {
            ...
            "schema": "pcb-gnn.corpus-v4-accuracy-checkpoint-index.v1",
        },
        "matrices.json": {
            "schema": "pcb-gnn.corpus-v4-accuracy-matrices.v1",
            "views": {"fixture": True},
        },
        "summary.json": summary,
        "task_index.json": {
            "entries": task_index_entries,
            "schema": "pcb-gnn.corpus-v4-accuracy-task-index.v1",
        },
    }
    ...
    monkeypatch.setattr(
        archive,
        "validate_protocol",
        lambda *_: ({"inputs": {}}, roots["protocol_sha256"]),
    )
    monkeypatch.setattr(
        archive,
        "validate_plan",
    ...
    monkeypatch.setattr(archive, "recompute_task_metrics", lambda *_: {})
