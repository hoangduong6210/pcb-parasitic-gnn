...
from corpus_v4_accuracy_dataset_v2 import (  # noqa: E402
...
PROTOCOL_PATH = ROOT / "protocols/corpus_v4_accuracy_v2.json"


@pytest.fixture(scope="session")
def canonical_dataset():
    return load_corpus_v4_accuracy_dataset_v2(ROOT, PROTOCOL_PATH)
