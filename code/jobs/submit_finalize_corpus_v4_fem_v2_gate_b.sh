#!/bin/bash
#SBATCH --job-name=pcb-v4-fem-v2-b-fin
...
: "${PCB_GNN_V4_FEM_V2_PREREQUISITE_ADMISSION:?Pin the Gate-A admission path}"
: "${PCB_GNN_V4_FEM_V2_PREREQUISITE_ADMISSION_SHA256:?Pin the Gate-A admission SHA-256}"
: "${PCB_GNN_V4_FEM_V2_SOURCE_ARRAY_JOB_ID:?Pin the Gate-B source array JobID}"
