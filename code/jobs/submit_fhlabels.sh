...
set -euo pipefail
echo "=== field-grade ALL inductances: FastHenry relabel + retrain ==="; hostname; date
cd ${REPO_ROOT}/code
source "${REPO_ROOT}/code/env.sh"   # composite PYTHONPATH
/usr/bin/python3 -u experiments/labels/experiments_fhlabels.py
echo DONE; date
