#!/bin/bash
#SBATCH --job-name=pcb-v4-e3-final
...
: "${PCB_GNN_V4_STRICT_E3_ARRAY_JOB_ID:?Set the completed corpus-v4 strict-E3 array ID}"
"$PCB_GNN_PYTHON" -u code/experiments/proofs/finalize_corpus_v3_strict_e3.py \
  --source-array-job-id "$PCB_GNN_V4_STRICT_E3_ARRAY_JOB_ID" --series corpus_v4
