...
TASK_ROW_SCHEMA = "pcb-gnn.corpus-v4-accuracy-task-row.v1"
LOCK_SCHEMA = "pcb-gnn.corpus-v4-accuracy-execution-lock.v1"
TASK_RESULT_SCHEMA = "pcb-gnn.corpus-v4-accuracy-task-result.v1"
TASK_MANIFEST_SCHEMA = "pcb-gnn.corpus-v4-accuracy-task-artifact-manifest.v1"
CANDIDATE_SCHEMA = "pcb-gnn.corpus-v4-accuracy-candidate-index.v1"
ACCEPTED_SCHEMA = "pcb-gnn.corpus-v4-accuracy-accepted-set.v1"
PENDING_SCHEMA = "pcb-gnn.corpus-v4-accuracy-pending-set.v1"
FINAL_SCHEMA = "pcb-gnn.corpus-v4-accuracy-final.v1"
...
PLANNER_SOURCE_NAMES = (
    ...
    "code/experiments/proofs/plan_corpus_v4_accuracy.py",
    "code/quality/verify_corpus_v4_archive.py",
    "code/quality/verify_corpus_v4_discrepancy_archive.py",
)
EXECUTION_SOURCE_NAMES = (
    ...
    "code/env.sh",
    "code/experiments/proofs/audit_corpus_v4_cps_fidelity_discrepancy.py",
    "code/experiments/proofs/build_corpus_v4_accuracy_execution_lock.py",
    "code/experiments/proofs/corpus_v4_accuracy_contract.py",
    "code/experiments/proofs/finalize_corpus_v4_accuracy.py",
    "code/experiments/proofs/plan_corpus_v4_accuracy.py",
    "code/experiments/proofs/plan_corpus_v4_accuracy_resume.py",
    "code/experiments/proofs/run_corpus_v4_accuracy_task.py",
    "code/inference/safe_npz_bundle.py",
    "code/jobs/slurm_job_env.sh",
    "code/jobs/submit_corpus_v4_accuracy.sh",
    "code/jobs/submit_finalize_corpus_v4_accuracy.sh",
    "code/models/gnn/gnn_baseline.py",
    "code/quality/verify_corpus_v4_archive.py",
    "code/quality/verify_corpus_v4_accuracy_archive.py",
    "code/quality/verify_corpus_v4_discrepancy_archive.py",
...
def validate_protocol(path: Path, expected_sha256: str | None = None) -> tuple[dict[str, Any], str]:
        ...
        "targets": [
            {
                ...
                "source": "finalized Corpus V4 long-form observations",
                "units": "pF",
            },
            *[
                {
    ...
    if protocol.get("protocol_name") != "corpus-v4-family-crossed-accuracy-v1":
        raise ValueError("accuracy protocol name differs from the frozen v1 identity")
...
def validate_execution_lock(path: Path, expected_sha256: str) -> tuple[dict[str, Any], str]:
    ...
    for name in ("plan_sha256", "protocol_sha256", "task_manifest_sha256"):
