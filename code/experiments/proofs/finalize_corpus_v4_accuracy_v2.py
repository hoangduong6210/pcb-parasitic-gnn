...
from corpus_v4_accuracy_dataset_v2 import load_corpus_v4_accuracy_dataset_v2  # noqa: E402
from plan_corpus_v4_accuracy_resume_v2 import validate_attempt  # noqa: E402
from run_corpus_v4_accuracy_task_v2 import (  # noqa: E402
    NORMALIZATION_NAMES,
    TrainOnlyNormalizer,
    _graph_samples,
    _model_from_arrays,
...
PREDICTION_SCHEMA = "pcb-gnn.corpus-v4-accuracy-prediction.v2"
ANALYSIS_MANIFEST_SCHEMA = "pcb-gnn.corpus-v4-accuracy-analysis-manifest.v2"
TASK_METRICS_SCHEMA = "pcb-gnn.corpus-v4-accuracy-task-metrics.v2"
REFERENCE_GAP_SCHEMA = "pcb-gnn.corpus-v4-accuracy-reference-fidelity-gap.v2"
SCIENTIFIC_SCOPE = {
...
def _validate_accepted_set(
    ...
    *,
    ...
    if set(candidate) != {"entries", "schema"} or candidate.get("schema") != "pcb-gnn.corpus-v4-accuracy-candidate-index.v2":
...
def main() -> None:
    ...
    expected_batch_hash = lock["source_sha256"]["code/jobs/submit_finalize_corpus_v4_accuracy_v2.sh"]
    ...
    dataset = load_corpus_v4_accuracy_dataset_v2(ROOT, args.protocol)
    ...
    try:
        ...
        atomic_write_json(temporary / "matrices.json", {"schema": "pcb-gnn.corpus-v4-accuracy-matrices.v2", "views": matrices})
        atomic_write_json(
        ...
        atomic_write_json(temporary / "checkpoint_index.json", {"entries": checkpoint_index, "schema": "pcb-gnn.corpus-v4-accuracy-checkpoint-index.v2"})
        atomic_write_json(temporary / "task_index.json", {"entries": task_index, "schema": "pcb-gnn.corpus-v4-accuracy-task-index.v2"})
