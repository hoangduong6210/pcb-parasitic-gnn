...
DATASET_ROW_SCHEMA = "pcb-gnn.corpus-v4-accuracy-evaluation-row.v2"
TASK_SCHEMA = "pcb-gnn.corpus-v4-accuracy-task-row.v2"
DEFAULT_PROTOCOL = ROOT / "protocols/corpus_v4_accuracy_v2.json"
DEFAULT_OUT = ROOT / "results/corpus_v4/accuracy_v2/plan/v1"
ARTIFACT_NAMES = (
...
def validate_protocol(protocol: dict[str, Any]) -> None:
    ...
    if protocol.get("protocol_name") != "corpus-v4-fem-v2-family-crossed-accuracy-v2":
        raise AccuracyPlanError("unexpected accuracy-v2 protocol identity")
    if protocol.get("upstream_archive_git_commit") != (
        "d512cf242a5b2b8faf60de9c6bba0a814f867ec6"
    ):
        raise AccuracyPlanError("accuracy-v2 archive commit is not frozen")
    ...
    *, root: Path = ROOT, protocol_path: Path = DEFAULT_PROTOCOL
    ...
    plan = {
        ...
        "planner_source_sha256": {
            ...
            "code/experiments/proofs/plan_corpus_v4_accuracy_v2.py": sha256_file(
