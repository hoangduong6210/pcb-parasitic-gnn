#!/usr/bin/env python3
"""
experiments_v3.py — supplementary architecture and scaling studies.
...
Reuses experiments_v2.train_eval. SLURM only (HARD RULE).
"""
import json
import platform
import time
...
from pipeline import load_dataset, build_samples, TARGETS
...
def main():
    layouts, labels, meta = load_dataset(ROOT / "datasets" / "synth_v1")
