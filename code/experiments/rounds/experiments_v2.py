#!/usr/bin/env python3
"""
experiments_v2.py — validation, multi-seed, and sparse-graph studies.
...
Writes results/run_v2/results_v2.json.

Runs via sbatch on a compute node (HARD RULE). No login-node compute.
"""
import argparse
import json
import platform
...
from pipeline import load_dataset, build_samples, old_peec_cps_baseline, TARGETS
...
def main():
    ...
    ap.add_argument("--data", default="../datasets/synth_v1")
    ap.add_argument("--out", default="../results/run_v2")
