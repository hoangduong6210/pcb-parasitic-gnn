#!/usr/bin/env python3
"""
scaling_experiment.py — Honest wall-time scaling study for this project.
...
Runs via sbatch on a compute node (HARD RULE: never heavy on login).
"""
import argparse
import json
import platform
...
def main():
    ...
    ap.add_argument("--out", type=str, default="../results/scaling_v1")
    ap.add_argument("--ckpt", type=str, default="../results/run_v1/gnn_checkpoint.pt")
