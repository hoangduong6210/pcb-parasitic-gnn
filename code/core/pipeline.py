#!/usr/bin/env python3
"""
pipeline.py — GNN training + honest evaluation for this project.
...
Intended to run via sbatch on a compute node (HARD RULE: never heavy on login).
"""
import argparse
import json
import platform
...
def main():
    ...
    ap.add_argument("--data", type=str, default="../datasets/synth_v0")
    ap.add_argument("--out", type=str, default="../results/run_v1")
