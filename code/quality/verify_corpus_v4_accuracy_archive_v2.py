...
from corpus_v4_accuracy_contract_v2 import (  # noqa: E402
    FINAL_SCHEMA,
    assert_finite_json,
    canonical_task_row,
    canonical_tres,
...
from finalize_corpus_v4_accuracy_v2 import (  # noqa: E402
...
from plan_corpus_v4_accuracy_resume_v2 import validate_attempt  # noqa: E402
...
ANALYSIS_SCHEMA = "pcb-gnn.corpus-v4-accuracy-analysis-manifest.v2"
ARCHIVE_SCHEMA = "pcb-gnn.corpus-v4-accuracy-archive.v2"
...
def verify_archive(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if (
        ...
        != "pcb-gnn.corpus-v4-accuracy-task-index.v2"
