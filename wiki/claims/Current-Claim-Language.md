...
| `C-BASE-FEMV2-001` | `VALIDATED; SCIENTIFIC ADMISSION PENDING` | The frozen baseline comparison passed checkpoint admission, held-out finalization, exact reconstruction and clean-tracked replay. Its [result page](../results/Corpus-V4-FEM-v2-Baselines.md) records the numerical outcome and proposed wording, not yet eligible for paper export. | Project-owner scientific admission; execution indexed by `E-C4-BASE-FEMV2-PLAN-01`. |
