...
| [v3](Corpus-V4-FEM-V2-Accuracy-Protocol-v3.md) | `CHECKPOINT ARRAY ACTIVE` | Split-scoped training inputs and a filesystem sandbox enforce the local pre-acceptance byte boundary. Job `7087033` admitted array `7087054`; no held-out inference or result is admitted. |
