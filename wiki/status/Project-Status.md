...
| FEM-R3P16 repeatability diagnostic | `CORRECTION FROZEN / NOT ADMITTED` | The first source array completed, but finalization rejected a retained scheduler-schema mismatch; the corrected contract requires a complete rerun and no result, claim, or speed eligibility exists yet |
...
2. Rerun and finalize the corrected FEM repeatability diagnostic. Apply its
