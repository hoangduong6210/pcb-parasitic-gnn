...
This directory contains publication-package material only. Raw scheduler IDs,
machine paths, logs, and internal audit reports belong outside the manuscript
package.
