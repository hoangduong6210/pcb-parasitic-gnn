...
- Added `Paper_Full` as an independent, extended IEEE-style manuscript without
  replacing the historical page-limited submission.
...
- Added six deterministic vector figures and a complete LaTeX build.
